    ...
    Crafty.sprite(16, "http://stuff.allthekingsprojects.com/rft_fiddle/sprite.png", {
        grass1: [0, 0],
        grass2: [1, 0],
        grass3: [2, 0],
        grass4: [3, 0],
    ...
    Crafty.scene("loading", function () {
        ...
        Crafty.load(["http://stuff.allthekingsprojects.com/rft_fiddle/sprite.png"], function () {
    ...
    Crafty.c('Ape', {
        Ape: function() {
                ...
                .bind('Moved', function(from) {
                    ...
                    //hit() returns an array of hit objects
                    //[{type: "MBR", obj: Ent}, ...]
                    //http://craftyjs.com/api/Collision.html#-hit
                    if(hit){
